...
class FilePanel(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        # Apply options
        self._apply_auto_checkbox = QCheckBox("Apply corrections automatically when both files are loaded")
        self._apply_auto_checkbox.setChecked(self._config.get_bool("Correction", "auto_save_corrections", fallback=True))
    ...
    def _load_input_file(self) -> None:
        ...
        try:
            ...
            if (self._apply_auto_checkbox.isChecked() and 
                self._correction_rules and self._entries):
    ...
    def _on_auto_apply_changed(self, state: int) -> None:
        ...
        self._apply_button.setEnabled(
            not is_checked and self._entries and self._correction_rules
        )
