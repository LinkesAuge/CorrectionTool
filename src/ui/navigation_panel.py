...
from PySide6.QtWidgets import (
    QButtonGroup, QLabel, QPushButton, QSizePolicy, 
...
class NavigationPanel(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        title_label.setStyleSheet("font-size: 18px; font-weight: bold; color: white; margin-bottom: 20px;")
